...
import net.aryobw9.testmod.entity.animations.ModAnimationDefenition;
...
public class DwarfModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(ModAnimationDefenition.MOVE,limbSwing,limbSwingAmount,2f,10f);
		this.animate(((DwarfEntity)entity).idleAnimationState, ModAnimationDefenition.NORMAL,ageInTicks,1f);
	}
